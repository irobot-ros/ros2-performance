...
do
    ...
    do
        ...
        echo "${rmw} - COMMAND: ./irobot-benchmark multi-process/1n_1s_${msg}.json -x 1 --tracking off -t 30 --ros_params off"
        ./irobot-benchmark multi-process/1n_1s_${msg}.json -x 1 --tracking off -t 30 --ros_params off
