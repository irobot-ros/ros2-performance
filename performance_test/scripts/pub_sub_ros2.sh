    ...
    do
      ...
      do
        ...
        do
          ...
          CMD_ARGS="--subs $NUM_SUBSCRIBERS --pubs $NUM_PUBLISHERS --msg_type $MSG_TYPE --msg_size $MSG_SIZE --frequency $PUB_FREQ --duration $DURATION --executors 0 --filename $LAT_REL_FILE_PATH"
