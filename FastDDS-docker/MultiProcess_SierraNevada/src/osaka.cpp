...
/**
 * @file osaka.cpp
 * Replicates the performance benchmark of osaka topology
 *
 */

// Include messages used in osaka topology
...
public:
    ...
    virtual ~Osaka()
    {
        ...
        DESTRUCTOR_SUB(parana)
        DESTRUCTOR_PUB(salween)
    ...
    void run(int experiment_duration_sec)
    {
        ...
        std::thread t_pub_salween  (&Osaka::publish<Stamped12Float32>, this, writer_salween_,  100, 48,    "salween");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "Starting osaka. Duration: " << experiment_duration_sec
              << " seconds.\n" << std::endl;
    ...
    if(osaka->init()) {
        ...
        osaka->run(experiment_duration_sec);
    } else {
