...
EventsLogger::EventsLogger(const std::string & filename)
{
  ...
  _file << std::left << std::setw(_p_caller_width) << std::setfill(_p_separator) << "Caller";
  _file << std::left << std::setw(_p_code_width) << std::setfill(_p_separator) << "Code";
  _file << std::left << std::setw(_p_desc_width) << std::setfill(_p_separator) << "Description";
  _file << std::endl;
}
...
void EventsLogger::write_event(const Event & event)
{
  ...
  _file << std::left << std::setw(_p_time_width) << std::setfill(_p_separator) <<
    event_timestamp_ms;
  _file <<
