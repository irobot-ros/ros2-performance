...
int main(int argc, char** argv)
{
    ...
    std::cout << "Parameter services: " << (options.ps ? "on" : "off") << std::endl;
    std::cout << "Parameter event publisher: " << (options.pep ? "on" : "off") << std::endl;
    ...
    performance_test::TemplateFactory factory = performance_test::TemplateFactory(options.ipc, options.ps, options.pep);
