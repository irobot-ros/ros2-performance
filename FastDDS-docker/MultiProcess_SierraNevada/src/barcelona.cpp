...
/**
 * @file barcelona.cpp
 * Replicates the performance benchmark of barcelona topology
 *
 */

// Include messages used in barcelona topology
...
public:
    ...
    void run(int experiment_duration_sec)
    {
        ...
        std::thread t_pub_lena (&Barcelona::publish<StampedVector>, this, writer_lena_, 100, 50, "lena");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "Starting barcelona. Duration: " << experiment_duration_sec
              << " seconds.\n" << std::endl;
    ...
    if(barcelona->init()) {
        ...
        barcelona->run(experiment_duration_sec);
    } else {
